...
var (
	...
	ErrFailedToGetEligibleMembersByVerifyingAttacks = errors.New("failed to get eligible members by verifying attacks")
	ErrNoMemberEligible                             = errors.New("no eligible members found")
)
